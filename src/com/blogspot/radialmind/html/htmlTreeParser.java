...
public class htmlTreeParser extends TreeParser {
    ...
    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:15:1: document : element ;
    public final void document() throws RecognitionException {
        try {
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:15:10: ( element )
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:15:12: element
            {
    ...
    // $ANTLR start element
    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:17:1: element : ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( ^( SETTING attrName= GENERIC_ID ) )* ( element | text= PCDATA )* ) ;
    public final void element() throws RecognitionException {
        ...
        try {
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:18:5: ( ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( ^( SETTING attrName= GENERIC_ID ) )* ( element | text= PCDATA )* ) )
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:18:7: ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( ^( SETTING attrName= GENERIC_ID ) )* ( element | text= PCDATA )* )
            {
            ...
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:20:13: ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:21:17: ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE )
            	    {
            ...
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:24:13: ( ^( SETTING attrName= GENERIC_ID ) )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:25:15: ^( SETTING attrName= GENERIC_ID )
            	    {
            ...
            // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:29:13: ( element | text= PCDATA )*
            loop3:
            do {
                int alt3=3;
                ...
                switch (alt3) {
            	case 1 :
            	    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:29:14: element
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // /workspace/xssprotect/trunk/grammar/htmlTreeParser.g:30:15: text= PCDATA
            	    {
