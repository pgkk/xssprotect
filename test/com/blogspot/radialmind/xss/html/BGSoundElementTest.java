...
public class BGSoundElementTest extends BaseTestCase {
	String html = "<html><head><title>test</title></head><body><BGSOUND SRC=\"javascript:alert('XSS');\"></body></html>";
	
	public void testExecute() {
		testExecute(html, "<html><head><title>test</title></head><body><bgsound></bgsound></body></html>");
	}
}
